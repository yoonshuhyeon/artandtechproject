...
async def create_room(data: dict):
    ...
    new_room = RoomState(code=room_code, location=data.get("location", "장소 미정"), meeting_time=data.get("meeting_time", "시간 미정"), reservation_name=data.get("reservation_name", ""))
    save_room(new_room)
